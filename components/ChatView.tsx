...
const ChatView: React.FC<ChatViewProps> = ({ 
  ...
  return (
    <div className="w-full h-full relative overflow-hidden" onDragOver={e => { e.preventDefault(); setIsDragging(true); }} onDragLeave={() => setIsDragging(false)} onDrop={e => { e.preventDefault(); setIsDragging(false); handleFiles(e.dataTransfer.files); }}>
      ...
      {/* 1. HEADER (MERAH): LOCKED AT TOP (ABSOLUTE) */}
      ...
      {/* 3. CHAT AREA (BIRU): SCROLLABLE AREA */}
      <div 
        ref={scrollRef} 
        className="absolute inset-0 overflow-y-auto pt-[84px] md:pt-[110px] pb-[84px] md:pb-[110px] px-4 md:px-8 custom-scrollbar space-y-6"
      >
      ...
      {/* 2. FOOTER (HIJAU): LOCKED AT BOTTOM (ABSOLUTE) - FLEXIBLE DENGAN DVH */}
      ...
      {/* LOGIKA MODAL PROFIL & PAP (TETAP SAMA) */}
      {showProfilePreview && (
